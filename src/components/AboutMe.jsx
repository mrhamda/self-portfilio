        ...
        <div className="flex justify-center md:justify-start fromLeft">
          <div className="card">
            <img
              src="./Abdullah.jpg"
              alt="About me"
              className="rounded-lg shadow-md object-cover h-[28rem] z-2 "
            />
          </div>
        </div>
        ...
        <div className="relative flex flex-col bg-white shadow-sm border border-slate-200 rounded-lg md:w-1/2 h-[27rem] fromRight">
          ...
          <div className="p-4 flex flex-col justify-center h-full">
            <h5 className="mb-4 text-slate-800 text-xl font-semibold leading-tight">
              Abdullah Hamdan — Fullstack webdeveloper & Cybersecurity
              specialist
            </h5>
            <p className="text-slate-600 leading-relaxed font-light">
              ...
              like realtime chat apps and E-comernace site and such. Recently I
              have been engaged in cybersecruity for a while and learned the art
              of binary exploitation and web protection.
            </p>
          </div>
        </div>
      </div>
